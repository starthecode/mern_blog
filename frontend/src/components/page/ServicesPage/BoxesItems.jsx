...
export const BoxesItems = ({ BoxItem }) => {
  return (
    <div className="container my-20">
      <Heading
        type={'dark'}
        smallTitle={'AI'}
        title={'Amplify Business Efficiency with AI'}
        subText={
          'Bizmetric delivers the best in class performance when it comes to excellence. Our Artificial Intelligence specialists develop applications that are highly customized, and data focused. We help our clients harness the maximum benefit of AI by leveraging their decision-making capabilities.'
        }
      />
      ...
      <div className="mt-12 grid sm:grid-cols-3 lg:grid-cols-3 gap-3">
        {BoxItem &&
          BoxItem?.map((item, index) => (
            <div
              key={index}
              className="relative group overflow-hidden p-[2rem] rounded-[1.5rem] bg-white border"
            >
              <div
                aria-hidden="true"
