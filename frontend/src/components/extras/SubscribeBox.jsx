...
const SubscribeBox = () => {
  return (
    <div>
      <div className="border-dashed border-[1px] border-junglegreen-600/40 dark:border-junglegreen-400/40 rounded-md p-5 w-full bg-white dark:bg-woodsmoke-950 relative z-2">
        <h1 className="mb-3">
        ...
        <div className="flex flex-col md:flex-row lg:flex-col gap-2 mt-7">
          <input
            type="email"
            className="w-full md:w-1/2 lg:w-full text-sm border-gray-300 focus:border-gray-200 focus:ring-0 rounded-md bg-white py-3 px-3"
            id="Email"
