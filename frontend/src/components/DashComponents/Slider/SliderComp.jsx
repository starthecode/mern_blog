...
//   //     const current = watchAll.sliders;

//   //     const isSame = JSON.stringify(current) === JSON.stringify(slidersData);

//   //     if (!isSame) {
//   //       setValue('sliders', slidersData);
//   //     }
//   //   }
//   // }, [slidersData, watchAll.sliders, setValue]);
...
//       // Update the sliderImage at this index
//       setValue(`sliders.${index}.sliderImage`, uploadedUrl);
//       // setSlidersData((prev) => {
//       //   const copy = [...prev];
//       //   copy[index].sliderImage = uploadedUrl;
//       //   return copy;
//       // });
//     } catch (err) {
...
//         <div
//           key={item.id}
//           className="grid grid-cols-4 gap-2 p-4 mb-4 border rounded shadow-sm bg-gray-50"
//         >
//           <div>
//             <input type="file" onChange={(e) => handleImageUpload(e, index)} />
//             {watchAll?.sliders?.[index]?.sliderImage && (
//               <img
//                 src={`http://localhost:3000${watchAll.sliders[index].sliderImage}`}
//                 alt="preview"
//                 className="w-20 mt-2"
//               />
//             )}
