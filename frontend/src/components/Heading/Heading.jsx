  ...
  return (
    <div>
      {smallTitle && (
        ...
        >
          <h5
            className={`text-sm font-inter font-semibold text-foreground sm:leading-none uppercase block text-[#F4FFFA00] bg-clip-text bg-gradient-to-b ${
              type == 'dark'
      ...
      <motion.h2
        ...
        initial={{ opacity: 0 }}
        animate={controls}
        className={`block mb-5 text-3xl text-[#F4FFFA00] bg-clip-text bg-gradient-to-b ${
          type == 'dark'
